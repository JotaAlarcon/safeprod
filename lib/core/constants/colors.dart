...
class CustomColors {
  static Color backgroundLight = Color(0xffE2E9EB);
  static Color primaryLight = Color(0xff3D3377);
  static Color secondaryLight = Color(0xff68E8E8);
  static Color greenAlert = Color(0xff00CC2D);
